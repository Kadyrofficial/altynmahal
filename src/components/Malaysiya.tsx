  ...
  return (
    <div ref={boxRef} className={`w-full aspect-country bg-lightgray md:w-1/2 p-[10px] transform transition-opacity duration-[1.5s] ease-in-out ${isVisible ?  "opacity-1" : "opacity-0"}`}>
        <div className="w-full h-full bg-white ">
            <span className="text-[30px] font-medium absolute mt-[2%] ml-[3%] lg:text-[40px]">{t('malaysiya')}</span>
            <img src="/Malaysia.png" className="w-full h-full" alt="" />
        </div>
    </div>
  );
};

export default Malaysiya;